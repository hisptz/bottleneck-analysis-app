...
export class VisualizationLegendComponent implements OnInit {
  ...
  private _prepareLayerLegend(mapVisualizationSettings, mapVisualizationAnalytics, legendClasses): LegendSet {
    const legendId = mapVisualizationSettings ? mapVisualizationSettings.id : '';
    ...
    return {
      ...
      name: mapVisualizationSettings.layer === 'event' ? this.legend.getEventName(mapVisualizationAnalytics)[0] :
        mapVisualizationSettings.layer === 'boundary' ? 'Boundaries' : mapVisualizationSettings.layer === 'facility' ?
          'Facility' : mapVisualizationSettings.name,
      description: mapVisualizationAnalytics && mapVisualizationAnalytics.metaData ?
        mapVisualizationAnalytics.metaData.pe.map(period => mapVisualizationAnalytics.metaData.names[period]).join(', ') : '',
      pinned: false,
      ...
      isThematic: mapVisualizationSettings.layer !== 'event' && mapVisualizationSettings.layer !== 'boundary' &&
      mapVisualizationSettings.layer !== 'facility' ? true : false,
      ...
      classes: mapVisualizationSettings.layer !== 'boundary' && mapVisualizationSettings.layer !== 'facility' ?
