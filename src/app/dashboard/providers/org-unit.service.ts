...
export class OrgUnitService {
  ...
  getUserInformation () {
    return this.http.get(this.constant.root_url + 'api/me.json?fields=dataViewOrganisationUnits[id,level],organisationUnits[id,level]')
  ...
  getOrgunitLevelsInformation () {
    return this.http.get(this.constant.root_url + 'api/organisationUnitLevels.json?fields=id,name,level&order=level:asc')
      .map((response: Response) => response.json())
      .catch( this.handleError );
  }
  ...
  getOrgunitGroups () {
    return this.http.get(this.constant.root_url + 'api/organisationUnitGroups.json?fields=id,name&paging=false')
      .map((response: Response) => response.json())
      .catch( this.handleError );
  }
  ...
  getAllOrgunitsForTree (fields) {
    return this.http.get(this.constant.root_url + 'api/organisationUnits.json?filter=level:eq:1&paging=false&fields=' + fields)
      .map((response: Response) => response.json())
      .catch( this.handleError );
  }
  ...
  getAllOrgunitsForTree1 (fields,orgunits) {
    return this.http.get(this.constant.root_url + 'api/organisationUnits.json?fields=' + fields +'&filter=id:in:['+orgunits.join(",")+']&paging=false')
      .map((response: Response) => response.json())
      .catch( this.handleError );
  }
  ...
  getInitialOrgunitsForTree (orgunits) {
    return this.http.get(this.constant.root_url + 'api/organisationUnits.json?fields=id,name,children[id,name]&filter=id:in:['+orgunits.join(",")+']&paging=false')
      .map((response: Response) => response.json())
      .catch( this.handleError );
  }
