...
import { getAutoGeneratedLegendSet } from 'src/app/helpers/get-auto-generated-legend-set.helper';
  ...
  switch (favoriteType) {
    ...
    case 'TABLE': {
      return {
        ...
        legendSet: favoriteDetails.legendSet || getAutoGeneratedLegendSet()
      };
    }
    default:
      return {};
