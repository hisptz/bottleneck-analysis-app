...
export const convertToPng = (sourceElem, options) => domtoimage.toPng(sourceElem, options);

export const downloadFile = (fileBlob, filename) => FileSaver.saveAs(fileBlob, filename);
