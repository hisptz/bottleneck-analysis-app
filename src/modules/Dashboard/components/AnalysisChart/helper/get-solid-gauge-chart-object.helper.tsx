...
export function getSolidGaugeChartObject(initialChartObject: any, analyticsObject: any, chartConfiguration: any) {
  ...
  const sortedSeries = getSortedChartSeries(
    getChartSeries(analyticsObject, getChartAxisItems(analyticsObject, chartConfiguration.xAxisType, true), yAxisSeriesItems, chartConfiguration),
