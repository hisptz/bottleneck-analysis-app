...
import { LegendDefinition as LegendDefinitionType } from "../../../../../../../shared/types/dashboardConfig";
...
export default function LegendsDefinition() {
  ...
  const legendDefinitions: Array<LegendDefinitionType> = globalSelections?.[0]?.legendDefinitions;
  return (
