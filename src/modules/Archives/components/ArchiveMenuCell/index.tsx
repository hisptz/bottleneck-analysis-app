...
export default function ArchiveMenuCell({
	archive,
}: {
	archive: Archive;
}): React.ReactElement {
	...
	return (
		<DataTableCell className={classes["table-cell"]}>
			<div className="archive-menu-cell-action">
				<Button
					className="archive-menu-cell-action-test"
				...
				{stateActionRef && (
					...
					>
						<FlyoutMenu>
							<MenuItem
								className="archive-menu-cell-action-delete-test"
								onClick={onViewClick}
								icon={<IconView24 />}
								label={i18n.t("View")}
							/>
							{archiveAuthority.delete && (
								<MenuItem
									dataTest={"delete-archive-menu-button"}
