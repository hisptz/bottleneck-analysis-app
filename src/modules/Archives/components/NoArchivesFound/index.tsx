...
export default function NoArchivesFound({
	error,
	resetErrorBoundary,
}: ErrorBoundaryComponentProps): React.ReactElement {
	...
	if (error?.details?.httpStatusCode === 404) {
		return (
			<div className="column w-100 h-100 center align-center gap">
				...
				<h2 style={{ color: colors.grey800, margin: 0 }}>
					{i18n.t("There are currently no archived interventions")}
				</h2>
