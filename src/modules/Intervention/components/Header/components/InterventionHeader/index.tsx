...
export default function InterventionHeader(): React.ReactElement {
	...
	const [showDetails, setShowDetails] = useRecoilState(
		DisplayInterventionDetailsState(id),
	);
			...
			<div className="intervention-header-container">
				<div className="column flex-1">
					<div className="row gap align-center">
						...
						<span
							className="intervention-org-unit"
							style={{ color: colors.grey700 }}
						>
							{`${orgUnit?.displayName ?? ""} - ${period?.name ?? ""}`}
						</span>
						<Tooltip
							content={i18n.t("{{type}} bookmark", {
								type: !bookmarked
									? i18n.t("Add")
									: i18n.t("Remove"),
							})}
						>
							<IconButton
								className="intervention-bookmark"
						...
						<Tooltip
							content={i18n.t("{{type}} description", {
								type: showDetails
									? i18n.t("Hide")
									: i18n.t("Show"),
							})}
						...
						{authorities?.intervention?.edit && access.write ? (
							<Button
								...
								className={"configure-intervention"}
							...
							<PeriodSelectorModal
								calendar={
									calendar === CalendarTypes.ETHIOPIAN
										? CalendarTypes.ETHIOPIAN
										: CalendarTypes.GREGORIAN
								}
								singleSelection
								selectedPeriods={
									[selectedPeriod] as unknown as any
								}
				...
				<div className="column">
					<DropdownButton
						...
						component={
							<HelperMenu
								onClose={() => setOpenHelperMenu(false)}
							/>
						}
