...
import { OldInterventionConfig, GlobalSelection, SelectionGroup, SelectionItem } from "../../../../../shared/interfaces/oldInterventionConfig";
...
export const TableConfig = selectorFamily<TableConfigType, string>({
  ...
  get:
    ...
    ({ get }): TableConfigType => {
      ...
      const dashboard: OldInterventionConfig = get(DashboardState(id));
