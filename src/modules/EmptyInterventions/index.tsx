		...
		<div className="main-container">
			<div className="column align-center" style={{ gap: 32 }}>
						...
						<div className="info-box">
							<div className="column">
								<h3 className="info-box-title">
									{i18n.t("Create a new Intervention")}
								</h3>
								<ul className="info-box-list">
									<li>{i18n.t("Create Intervention")}</li>
									<li>
										{i18n.t(
											"Place indicators of intervention in their determinants in settings",
										)}
									</li>
									<li>
										{i18n.t(
									...
									<li>
										{i18n.t(
											"Select period and organisation unit and save changes",
										)}
									</li>
								</ul>
							</div>
				...
				{authorities?.intervention?.create && (
					<Button
						onClick={() => navigate("/new-intervention")}
						primary
						icon={<IconAdd24 />}
					>
